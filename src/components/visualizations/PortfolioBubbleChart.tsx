        ...
        <ResponsiveContainer width="100%" height="100%">
          <ScatterChart margin={{ top: 20, right: 30, bottom: 60, left: 60 }}>
            ...
            <YAxis 
              ...
              domain={[20, 70]}
              label={{ value: 'Expected Return (%)', angle: -90, position: 'left', offset: 20 }}
            />
      ...
      <Box sx={{ 
        ...
        <Paper sx={{ p: 2, bgcolor: 'background.paper' }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
            ...
            <Typography variant="body2">Strong Buy (70+)</Typography>
          </Box>
          <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
            <Box sx={{ width: 12, height: 12, bgcolor: '#5fa8d8', borderRadius: 0.5, mr: 1 }} />
            <Typography variant="body2">Buy (60-70)</Typography>
          </Box>
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            <Box sx={{ width: 12, height: 12, bgcolor: '#93c1e4', borderRadius: 0.5, mr: 1 }} />
            <Typography variant="body2">Hold (50-60)</Typography>
          </Box>
        </Paper>
        ...
        <Paper sx={{ p: 2, bgcolor: 'background.paper' }}>
          ...
          <Typography variant="body2" paragraph>• Larger bubbles = Higher market cap</Typography>
          <Typography variant="body2" paragraph>• BTC & ETH have best risk-adjusted returns</Typography>
          <Typography variant="body2">• Orange curve = Efficient frontier</Typography>
        </Paper>
      </Box>
    </Box>
  );
